...
const RSP = () => {
    ...
    return (
        <>
            ...
            <div>
                <button id="바위" className="btn" onClick={onClickBtn('바위')}>바위</button>
                <button id="가위" className="btn" onClick={onClickBtn('가위')}>가위</button>
                <button id="보" className="btn" onClick={onClickBtn('보')}>보</button>
            </div>
            <div>{result}</div>
            <div>현재 {score}점</div>
        </>
